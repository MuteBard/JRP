            ...
            <div className="ProjectPage1">
                <div className="pp1lvl1b1">
                    ...
                    <div className="pp1lvl2b4">
                        <div className="pp1lvl3b10">Research</div>
                        <div className="pp1lvl3b11">The Competitive analysis showed that the market were mostly for pets. This definitely was a plus for Good Samaritan since this app organically offered more features. The target audience were students and adults between the age of 20-35 with the trending pain points of either quickly running out of time or geographical inconvenience.</div>
                    </div>
                    ...
                    <div className="pp1lvl2b5">
                        ...
                        <div className="pp1lvl3b15">
                            <div className="pp1lvl4b18">Wireframes</div>
                    ...
                    <div className="pp1lvl2b6">
                        <div className="pp1lvl3b16">Project Duration</div>
                        <div className="pp1lvl3b17">The project took a month and a half. Most of that time was spent tweaking the user interface format and color scheme.</div>
                    </div>
